...
export interface ReviewLastEventClosureV1 {
	...
	// 提供方发送了本解码器读不懂的确认时设置。它刻意区别于缺失确认：
	// 宿主必须能区分“已批准、无可运行”与“已批准、且终结它的东西在场
	// 但这里读不懂”。
...
export function decodeReviewLastEventClosureV1(value: unknown): ReviewLastEventClosureV1 {
	...
	const shared: Pick<ReviewLastEventClosureV1, "schema" | "operation" | "lineageId" | "state" | "storeRevision"> = {
