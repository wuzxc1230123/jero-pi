...
export function decodeChangedPathEntry(value         , label        )                   {
...
export const NEXT_TRANSITION_OPERATIONS = ["review.start", "review.status", "review.recover", "review.repair", "review.acknowledge-approved"]         ;

export function decodeTransitionArguments(value         , label        )                                        {
...
export function decodeCaptureSubmission(value         , label        , v5         , v6         , captureOperation        )                            {
...
export function decodeProviderTask(value         , label        )                       {
