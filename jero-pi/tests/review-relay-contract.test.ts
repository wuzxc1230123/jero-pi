...
import { declareReviewRelayHandshake, GENTLE_PI_REVIEW_RELAY_CONTRACT, GENTLE_PI_REVIEW_RELAY_CONTRACT_ENV } from "../lib/review/review-relay-contract.ts";
...
test("declareReviewRelayHandshake exports the exact contract and reports whether it changed anything", () => {
	...
	const stale: NodeJS.ProcessEnv = { [GENTLE_PI_REVIEW_RELAY_CONTRACT_ENV]: "jero-pi.review-relay/v0" };
