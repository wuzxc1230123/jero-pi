...
export const REVIEW_CONSENT_LATCH_SCHEMA = "jero-pi.review-consent-asked/v1";
...
function reviewConsentLatchPath(cwd: string): string {
	...
	return assertManagedStorePathV1(authority.common_directory, join(authority.common_directory, "jero-pi", "review-consent", "asked.json"));
}
