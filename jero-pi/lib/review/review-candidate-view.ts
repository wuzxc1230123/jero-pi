...
// view safely discardable in favor of an already-bound one (jero-pi
...
export class CandidateViewRegistry {
	...
	bindCurrent(request: BindCandidateViewRequest): void {
		...
		// (jero-pi candidate-view rebind defect, ga#4085 / ga#4050).
	...
	/**
	 * Restores a lineage's FINALIZE binding (jero-pi #185): the stale entry
