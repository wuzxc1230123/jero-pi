...
// Kept independent of the native review CLI wrapper (`lib/native/native-review-cli.ts`)
...
/**
 * The minimal shape of `lib/agents/agents-config.ts`'s `ResolvedProfile` this
