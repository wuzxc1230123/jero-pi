...
} from "../core/model-routing-authority.ts";

export const PROFILES_KIND = "jero-pi.agent_model_profiles";
export const PROFILES_VERSION = 1;
export const PROFILE_EXPORT_KIND = "jero-pi.agent_model_profile";
