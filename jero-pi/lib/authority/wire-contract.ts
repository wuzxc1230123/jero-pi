// D7: the wire contract, internalized under the authority (design 6,
// review-integration-v2 -> lib/authority). Every gentle-ai.* schema string
// stays verbatim until the P5 identity pass; this module owns the wire
// vocabulary the controller consumes and wire.ts projects onto.
