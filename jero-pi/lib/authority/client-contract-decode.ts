...
import {
	...
	NATIVE_START_ACTION,
	type NativeReviewAbandonRequest,
	type NativeReviewConsentAnswerRequest,
	type NativeReviewConsentDeclinedResult,
	type NativeReviewErrorCode,
	type NativeReviewOperation,
	type NativeReviewProviderRoleCaptureArtifact,
	type NativeReviewReconcileAuthorityRequest,
	type NativeReviewRecoverRequest,
	type NativeReviewRecoveryResult,
	type NativeReviewUnachievableLensCaptureArtifact,
	type NativeSddStatusRequest,
	type NativeSddStatusV2,
	type NativeStartAction
...
// 路由规则保持一致。
function launchableExecFileTarget(file: string): { file: string; argumentsPrefix: readonly string[] } {
