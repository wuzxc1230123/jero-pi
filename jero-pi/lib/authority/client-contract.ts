// D7: the client contract, internalized under the authority (design 6,
// native-review-cli -> lib/authority). The fail-closed stub stays as the
// test-injectable reference and the Q-C unachievable surface; the production
// default is the in-process adapter (lib/jero-authority-cli.ts).
